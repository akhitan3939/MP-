...
export const BannerCarousel: React.FC = () => {
  ...
  const defaultBanners: BannerItem[] = [
    ...
    {
      id: 7,
      tagHi: '🤖 Google AI तकनीक',
      tagEn: '🤖 Powered by Google AI',
      badgeColor: 'bg-indigo-600 text-white',
      titleHi: 'Google AI-पावर्ड स्मार्ट स्कोर व कमजोरी विश्लेषण',
      titleEn: 'Google AI-Powered Diagnostic Weakness Analytics',
